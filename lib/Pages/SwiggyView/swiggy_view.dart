...
class SwiggyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: GetBuilder<SwiggyViewController>(builder: (vc) {
              ...
              children: [
                imageUrl != null && imageUrl!.contains("svg")
                    ...
                    : CachedNetworkImage(
                        ...
                        errorWidget: (b, s, o) {
                          return const Image(
                              image: AssetImage("assets/images/gnxt_logo.png"));
                        },
                        height: 40.h,
                      ),
                SizedBox(width: 4.w),
                Column(
                  ...
                  children: [
                    ...
                    GetBuilder<SwiggyViewController>(builder: (vc) {
                      return Row(
      ...
      body: Container(
        ...
        child: GetBuilder<SwiggyViewController>(builder: (vc) {
          return Row(
            children: [
              GetBuilder<SwiggyViewController>(builder: (vc) {
                return !vc.isLoadingSubCategories && vc.subCategories.isEmpty
                    ? SizedBox()
                    : Expanded(
                        flex: 3,
                        child: Container(
                          ...
                          child: !vc.isLoadingSubCategories
                              ? Stack(
                                  children: [
                                    ListView.builder(
                                        shrinkWrap: true,
              ...
              Expanded(
                  flex: 12,
                  child: GetBuilder<SwiggyViewController>(builder: (vc) {
                    return !vc.isLoadingSubCategories &&
                            vc.subCategories.isNotEmpty
                        ? PageView(
                            ...
                            children: svc.subCategories.map((e) {
                              ...
                              try {
                                if (vc.subIndex !=
                                    vc.subCategories.length - 1) {
                                  nextSub = vc
                                      .subCategories[vc.subCategories.indexOf(
                                              vc.selectedSubCategory!) +
                                          1]
                                      .name!;
                                }
                                if (vc.subIndex != 0) {
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    vc.products.isNotEmpty &&
                                        ...
                                        : const SizedBox(),
                                    vc.products.length > 5 && vc.isLastPage
                                        ? Padding(
                                            padding:
                                                            ...
                                                            return !vc.isLoading
                                                                ? Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                          " in ${svc.selectedSubCategory != null && svc.selectedSubCategory!.name!.isNotEmpty ? svc.selectedSubCategory!.name! : categoryName}")
                                                                    ],
                                                                  )
                                                                : Container(
  ...
  showFilterSheet(BuildContext context) async {
    await showModalBottomSheet(
        ...
        builder: (context) {
          return GetBuilder<SwiggyViewController>(builder: (vc) {
            return SizedBox(
                    ...
                    SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text("\u{20B9} " +
                                vc.filterPriceRange!.start.toStringAsFixed(0)),
                            Text("\u{20B9} " +
                                vc.filterPriceRange!.end.toStringAsFixed(0)),
                          ],
                        ),
                      ),
                    ),

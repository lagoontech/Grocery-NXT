...
class OnthewayOrderListItem extends StatelessWidget {
   OnthewayOrderListItem({super.key,this.order});
  ...
  Widget build(BuildContext context) {
    return  GestureDetector(
      onTap: () async {
        var result =
        await Get.to(() => OrderDetailsView(orderId: order!.orderId,orderStatus: "On the way"));
        if (result == 1) {
          vc.getOrders();
        }
      },

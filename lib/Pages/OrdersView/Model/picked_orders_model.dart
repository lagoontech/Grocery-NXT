...
//
//     final pickedOrdersModel = pickedOrdersModelFromJson(jsonString);

import 'dart:convert';

PickedOrdersModel pickedOrdersModelFromJson(String str) => PickedOrdersModel.fromJson(json.decode(str));

String pickedOrdersModelToJson(PickedOrdersModel data) => json.encode(data.toJson());

class PickedOrdersModel {
  AllOrders? allOrders;
  PickedSuborders? suborders;
  ...
  factory PickedOrdersModel.fromJson(Map<String, dynamic> json) => PickedOrdersModel(
    allOrders: json["all_orders"] == null ? null : AllOrders.fromJson(json["all_orders"]),
    suborders: json["suborders"] == null ? null : PickedSuborders.fromJson(json["suborders"]),
  );
...
class PickedSuborders {
  int? currentPage;
  List<PickedOrderDatum>? data;
  String? firstPageUrl;
  int? from;
  int? lastPage;
  String? lastPageUrl;
  ...
  factory PickedSuborders.fromJson(Map<String, dynamic> json) => PickedSuborders(
    currentPage: json["current_page"],
    data: json["data"] == null ? [] : List<PickedOrderDatum>.from(json["data"]!.map((x) => PickedOrderDatum.fromJson(x))),
    firstPageUrl: json["first_page_url"],
    from: json["from"],
    lastPage: json["last_page"],
    lastPageUrl: json["last_page_url"],
...
class PickedOrderDatum {
  ...
  factory PickedOrderDatum.fromJson(Map<String, dynamic> json) => PickedOrderDatum(
    id: json["id"],
    orderId: json["order_id"],

...
//
//     final orderPendingListModel = orderPendingListModelFromJson(jsonString);

import 'dart:convert';

OrderPendingListModel orderPendingListModelFromJson(String str) => OrderPendingListModel.fromJson(json.decode(str));

String orderPendingListModelToJson(OrderPendingListModel data) => json.encode(data.toJson());
...
class OrderPendingListModel {
  ...
  factory OrderPendingListModel.fromJson(Map<String, dynamic> json) => OrderPendingListModel(
...
enum Dimensions {
  ...
  THE_346_X_310_PIXELS,
  THE_679_X_679_PIXELS,
...
final dimensionsValues = EnumValues({
  ...
  "346 x 310 pixels": Dimensions.THE_346_X_310_PIXELS,
  "679 x 679 pixels": Dimensions.THE_679_X_679_PIXELS,
